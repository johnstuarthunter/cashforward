...
final class PaymentOptionsPanel extends javax.swing.JPanel {

    private final PaymentOptionsOptionsPanelController controller;

    PaymentOptionsPanel(PaymentOptionsOptionsPanelController controller) {
        this.controller = controller;
        initComponents();
        cbRequireLabel.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                PaymentOptionsPanel.this.controller.changed();
            }
        });
    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cbRequireLabel, org.openide.util.NbBundle.getMessage(PaymentOptionsPanel.class, "PaymentOptionsPanel.cbRequireLabel.text")); // NOI18N
